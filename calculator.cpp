...
#pragma region Windows Form Designer generated code
...

		{
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(72, 81);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(72, 50);
...
#pragma endregion
	...
	private: System::Void btnplus_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		double Trip1 = Double::Parse(textBox1->Text);

		double Trip2 = Double::Parse(textBox2->Text);

		

		double result = Trip1 + Trip2;
